...
import cz.cuni.mff.d3s.jdeeco.gossip.grouper.GrouperIntervalRange;
import cz.cuni.mff.d3s.jdeeco.gossip.grouper.GrouperRange;
import cz.cuni.mff.d3s.jdeeco.gossip.grouper.RangeConfigurator;
import cz.cuni.mff.d3s.jdeeco.gossip.grouper.client.GrouperClientPlugin;
import cz.cuni.mff.d3s.jdeeco.gossip.grouper.server.GrouperServerPlugin;
import cz.cuni.mff.d3s.jdeeco.gossip.grouper.server.PartitionedByProcessor;
